...
SRCM = main.c \
		...
		executor/path_handler_multi.c  utils/replace_vars.c  utils/export_hard.c utils/change_all_var.c utils/calculate_len.c utils/ft_split_utils2.c utils/ft_split_utils1.c utils/replace_var_utils.c
