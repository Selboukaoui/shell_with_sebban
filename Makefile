...
SRCM = main.c \
		...
		builtins_fun/ft_cd.c  builtins_fun/ft_pwd.c  builtins_fun/handle_single_builtin.c builtins_fun/env_builtin.c builtins_fun/echo_builtin.c utils/ft_get_value.c utils/exit_status.c builtins_fun/export_builtin.c builtins_fun/unset_builtin.c builtins_fun/exit_builtin.c builtins_fun/save_pwd.c builtins_fun/handle_single_builtin2.c utils/handle_dollar_quotes.c utils/replace_var_equals_var.c 
